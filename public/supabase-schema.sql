...
-- Legado: o portal nao utiliza mais `public.collaborators`.
-- Evite qualquer limpeza automatica nessa tabela compartilhada com o intranet.
...
-- =========================================================
-- USUARIOS EXCLUSIVOS DO PORTAL DE TREINAMENTOS
-- =========================================================
...
create index if not exists idx_training_user_categories_category_id on public.training_user_categories(category_id);
create index if not exists idx_training_user_module_status_module_id on public.training_user_module_status(module_id);
create index if not exists idx_training_users_is_active on public.training_users(is_active);
